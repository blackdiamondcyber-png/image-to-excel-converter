...
export default function Header({ step, onReset }) {
  ...
  return (
    <header className="bg-gradient-to-br from-snap-surface to-snap-bg border-b border-snap-border px-4 sm:px-5 pt-5 pb-3.5 flex items-center justify-between sticky top-0 z-50 safe-area-top">
