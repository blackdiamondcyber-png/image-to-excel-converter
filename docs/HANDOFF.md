...
- Production: https://image-to-excel-convertor.vercel.app serves a production build of `main` at `bd638f3` (deployment `dpl_2WBF4JDQG1LMR4z8SdbprBkiu9Sh`, created through the Vercel API on 2026-09-25). All three production addresses point at it.
